...
namespace Section_11
{
    ...
    public class InheritanceTest
    {
        ...
        public void Composition_Test()
        {
            ...
            Student myStudent = new Student("1111", "Bob", "Baker", 26, "Computer Science", "9999", dob);
            //myStudent.GetExerciseHabits();
        }
        ...
        public void Test_Student_As_Person()
        {
            ...
            Person myPerson = new Person("1212", "Baker", "Sarah", 24);
            DateTime dob = new DateTime(1980, 5, 20);
            Student myStudent = new Student("1111", "Bob", "Baker", 26, "Computer Science", "9999", dob);
