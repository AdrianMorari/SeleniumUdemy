...
namespace Section_11
{
    class Musical : Ticket
    {
        ...
        public Musical(int seatNum, string rowId, string nameEvent, string type, string location,
            string performer, string eventDateTime, bool memoriability, bool backStage, bool signsAutograph, double cost)
